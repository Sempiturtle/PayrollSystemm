    ...
    <div class="h-14 px-5 flex items-center gap-3 relative overflow-hidden">
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5 relative z-10 group">
            ...
            <div class="flex flex-col">
                <span class="text-[11px] font-bold text-white tracking-[0.2em] uppercase leading-none mb-1 italic">AISAT</span>
                <span class="text-[9px] font-bold text-[#D4AF37] tracking-[0.3em] uppercase leading-none opacity-80">Institutional</span>
            </div>
        </a>
    </div>
    ...
    <div class="p-3 border-t border-white/5 bg-black/20">
        <div class="flex items-center gap-2.5 group">
            ...
            <div class="flex-1 min-w-0">
                <div class="text-[11px] font-['DM_Serif_Text'] text-white truncate leading-none mb-1">{{ Auth::user()->name }}</div>
                <div class="text-[7px] text-[#D4AF37] font-bold uppercase tracking-[0.2em] leading-none">{{ Auth::user()->role }} Auth</div>
            </div>
...
<nav x-show="mobileSidebar" x-cloak class="fixed inset-0 z-50 lg:hidden">
    ...
    <div x-show="mobileSidebar" 
        ...
        <div class="h-16 px-8 border-b border-white/5 flex justify-between items-center relative overflow-hidden">
            <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#660000]/20 to-transparent"></div>
