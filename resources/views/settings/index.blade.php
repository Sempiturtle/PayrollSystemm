        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-slate-100">
                <div class="p-8">
                    ...
                    <div x-data="{ showForm: false }" class="mb-12 flex flex-col sm:flex-row items-center gap-6">
                    ...
                    {{-- Manual Parameter Creation Form --}}
                    <div x-show="showForm" x-collapse class="mb-8 p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4 shadow-sm">
