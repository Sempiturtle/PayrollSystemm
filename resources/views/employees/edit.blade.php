                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div x-show="empType !== 'professor'" style="display:none;">
                                        ...
                                        <input type="number" step="0.01" name="monthly_salary" value="{{ $employee->monthly_salary }}" class="w-full bg-slate-50/50 border border-slate-200 rounded-xl py-2 px-3 focus:outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/10 text-xs font-bold text-emerald-600" :required="empType !== 'professor'">
                                    </div>
                                </div>
