    ...
    <div class="space-y-8 animate-in-up">
        <div class="bg-white rounded-[3rem] border border-[#101D33]/5 shadow-[0_30px_100px_rgba(16,29,51,0.06)] overflow-hidden">
            <div class="p-8 border-b border-[#101D33]/5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 bg-[#FDFCF8]/30">
                <div>
                    <h1 class="text-3xl font-['DM_Serif_Display'] text-[#101D33] leading-none">Institutional <span class="text-[#660000]">Registry</span></h1>
                    <p class="text-sm text-slate-500 mt-2 font-['DM_Serif_Text'] italic opacity-70">Authoritative directory of active faculty, administrative personnel, and operational staff.</p>
                </div>
                <div class="flex items-center gap-4">
                    <a href="{{ route('employees.create') }}" class="group relative px-8 py-4 bg-[#101D33] text-white rounded-[2rem] font-bold text-sm shadow-[0_20px_40px_rgba(16,29,51,0.2)] transition-all hover:scale-[1.02] active:scale-[0.98] overflow-hidden flex items-center gap-3">
                        ...
                        <svg class="w-5 h-5 relative z-10 text-[#D4AF37]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
            ...
            <!-- Search Console -->
            <div class="px-8 py-6 bg-[#FDFCF8]/10 border-b border-[#101D33]/5">
                <form action="{{ route('employees.index') }}" method="GET" class="relative group">
                    ...
                    <input 
                        ...
                        value="{{ $search ?? '' }}"
                        class="w-full pl-16 pr-8 py-5 bg-white border border-[#101D33]/5 rounded-[2rem] text-sm font-['DM_Serif_Text'] text-[#101D33] placeholder-[#101D33]/20 focus:ring-2 focus:ring-[#101D33] focus:border-transparent transition-all shadow-sm"
                    >
                </form>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-[#101D33] text-[10px] font-bold text-white/40 uppercase tracking-[0.3em]">
                            <th class="px-10 py-6 border-r border-white/5">Identity Stream</th>
                            <th class="px-10 py-6 border-r border-white/5">Classification</th>
                            <th class="px-10 py-6 border-r border-white/5 text-center">RFID Authorization</th>
                            <th class="px-10 py-6 border-r border-white/5">Remuneration Rate</th>
                        ...
                        <tr class="hover:bg-[#FDFCF8] transition-all group">
                            <td class="px-10 py-8">
                                <div class="flex items-center gap-5">
                                    ...
                                    <div>
                                        <div class="text-base font-['DM_Serif_Text'] text-[#101D33] tracking-tight leading-none mb-2">{{ $employee->name }}</div>
                                        <div class="text-[10px] font-bold text-slate-300 uppercase tracking-[0.2em] leading-none">{{ $employee->employee_id }} Registry</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-10 py-8">
                            ...
                            <td class="px-10 py-8 text-center">
                                <code class="inline-block px-4 py-2 bg-[#101D33]/5 rounded-xl text-[11px] font-bold text-[#101D33]/60 tracking-widest tabular-nums border border-[#101D33]/5">
                                    {{ $employee->rfid_card_num ?? 'NOT_REGISTERED' }}
                                </code>
                            </td>
                            <td class="px-10 py-8">
                                <div class="flex items-baseline gap-1">
                                    <span class="text-[10px] font-bold text-slate-300 uppercase tracking-widest">PHP</span>
                                    <span class="text-lg font-['DM_Serif_Display'] text-[#101D33] tabular-nums">{{ number_format($employee->hourly_rate, 2) }}</span>
                                    <span class="text-[10px] font-bold text-slate-300 uppercase tracking-widest">/ HR</span>
                                </div>
                            </td>
                            <td class="px-10 py-8 text-right">
                                <div class="flex justify-end gap-4 opacity-0 group-hover:opacity-100 transition-all transform translate-x-4 group-hover:translate-x-0">
                                    <a href="{{ route('employees.edit', $employee) }}" class="w-10 h-10 flex items-center justify-center text-[#101D33]/40 hover:text-[#101D33] hover:bg-white rounded-xl transition-all shadow-none hover:shadow-lg border border-transparent hover:border-[#101D33]/5">
            ...
            <div class="px-10 py-8 bg-[#FDFCF8]/30 border-t border-[#101D33]/5">
                {{ $employees->links() }}
            </div>
            @endif
        </div>
