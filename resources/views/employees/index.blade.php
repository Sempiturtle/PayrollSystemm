<x-app-layout>
    ...
    <div class="space-y-6 animate-in-up">
        <div class="bg-white rounded-3xl border border-[#101D33]/5 shadow-[0_30px_100px_rgba(16,29,51,0.06)] overflow-hidden">
            <div class="p-4 border-b border-[#101D33]/5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[#FDFCF8]/30">
                <div>
                    <h1 class="text-xl font-['DM_Serif_Display'] text-[#101D33] leading-none">Institutional <span class="text-[#660000]">Registry</span></h1>
                    <p class="text-[11px] text-slate-500 mt-1 font-['DM_Serif_Text'] italic opacity-70">Authoritative directory of personnel and operational staff.</p>
                </div>
                <div class="flex items-center gap-3">
                    <a href="{{ route('employees.create') }}" class="group relative px-5 py-2.5 bg-[#101D33] text-white rounded-xl font-bold text-[11px] shadow-[0_20px_40px_rgba(16,29,51,0.2)] transition-all hover:scale-[1.02] active:scale-[0.98] overflow-hidden flex items-center gap-2">
            ...
            <!-- Search Console -->
            <div class="px-5 py-3 bg-[#FDFCF8]/10 border-b border-[#101D33]/5">
                <form action="{{ route('employees.index') }}" method="GET" class="relative group">
                    <div class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#101D33]/20 group-focus-within:text-[#101D33] transition-colors">
                    ...
                    <input 
                        ...
                        value="{{ $search ?? '' }}"
                        class="w-full pl-12 pr-5 py-3 bg-white border border-[#101D33]/5 rounded-xl text-[13px] font-['DM_Serif_Text'] text-[#101D33] placeholder-[#101D33]/20 focus:ring-2 focus:ring-[#101D33] focus:border-transparent transition-all shadow-sm"
                    >
                </form>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-[#101D33] text-[8px] font-bold text-white/40 uppercase tracking-[0.3em]">
                            <th class="px-5 py-3 border-r border-white/5">Identity Stream</th>
                            <th class="px-5 py-3 border-r border-white/5">Classification</th>
                            <th class="px-5 py-3 border-r border-white/5 text-center">RFID Authorization</th>
                            <th class="px-5 py-3 border-r border-white/5">Remuneration</th>
                    ...
                    <tbody class="divide-y divide-[#101D33]/5">
                        ...
                        <tr class="hover:bg-[#FDFCF8] transition-all group">
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-xl bg-[#101D33] text-white flex items-center justify-center font-['DM_Serif_Display'] text-base shadow-xl shadow-[#101D33]/10 border border-white/10 overflow-hidden relative">
                            ...
                            <td class="px-5 py-3 text-right">
                                <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all transform translate-x-4 group-hover:translate-x-0">
                                    <a href="{{ route('employees.edit', $employee) }}" class="w-8 h-8 flex items-center justify-center text-[#101D33]/40 hover:text-[#101D33] hover:bg-white rounded-lg transition-all shadow-none hover:shadow-lg border border-transparent hover:border-[#101D33]/5">
                                    ...
                                    <form action="{{ route('employees.destroy', $employee) }}" method="POST" onsubmit="return confirm('Archive this institutional asset?');">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="w-8 h-8 flex items-center justify-center text-[#660000]/40 hover:text-[#660000] hover:bg-white rounded-lg transition-all shadow-none hover:shadow-lg border border-transparent hover:border-[#660000]/5">
